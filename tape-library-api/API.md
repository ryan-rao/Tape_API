...
| POST /api/v1/drives/{drive}/eof | `mt -f /dev/nstX eof N` | L3 |
| POST /api/v1/drives/{drive}/position | `mt -f /dev/nstX {fsf,fsfm,bsf,bsfm,fsr,bsr,fss,bss,asf} N` | L2 |
| POST /api/v1/drives/{drive}/rewind | `mt -f /dev/nstX rewind` | L2 |
| POST /api/v1/drives/{drive}/offline | `mt -f /dev/nstX offline` | L2 |
| POST /api/v1/drives/{drive}/rewoffl | `mt -f /dev/nstX rewoffl` | L2 |
| POST /api/v1/drives/{drive}/eject | `mt -f /dev/nstX eject` | L2 |
| POST /api/v1/drives/{drive}/retension | `mt -f /dev/nstX retension` | L2 |
| POST /api/v1/drives/{drive}/eod | `mt -f /dev/nstX eod` | L2 |
| POST /api/v1/drives/{drive}/seod | `mt -f /dev/nstX seod` | L2 |
| POST /api/v1/drives/{drive}/seek | `mt -f /dev/nstX seek N` | L2 |
| GET /api/v1/drives/{drive}/tell | `mt -f /dev/nstX tell` | L1 |
| POST /api/v1/drives/{drive}/erase | `mt -f /dev/nstX erase` | L3 |
| POST /api/v1/drives/{drive}/lock | `mt -f /dev/nstX lock` | L2 |
| POST /api/v1/drives/{drive}/unlock | `mt -f /dev/nstX unlock` | L2 |
| POST /api/v1/drives/{drive}/load | `mt -f /dev/nstX load` | L2 |
| POST /api/v1/drives/{drive}/compression | `mt -f /dev/nstX compression 0\|1` | L2 |
| POST /api/v1/drives/{drive}/block-size | `mt -f /dev/nstX setblk N` | L2 |
| POST /api/v1/drives/{drive}/density | `mt -f /dev/nstX setdensity N` | L2 |
| POST /api/v1/drives/{drive}/partition | `mt -f /dev/nstX setpartition N` / `mkpartition N`（body 传 partition 或 count） | L2 / L3 |
| POST /api/v1/drives/{drive}/partition/seek | `mt -f /dev/nstX partseek P,B` | L2 |
| GET /api/v1/drives/{drive}/densities | `mt -f /dev/nstX densities` | L1 |
| GET /api/v1/drives/{drive}/options | `mt -f /dev/nstX stshowoptions` | L1 |
